...
class Picker extends React.Component {
  ...
  renderSection(section) {
    ...
    const key = section[valueKey];
    return (
      <View key={key} style={[styles.sectionStyle,this.props.sectionStyle]}>
        <Text style={[styles.sectionTextStyle,this.props.sectionTextStyle]}>{label}</Text>
      </View>
    );
  }
  ...
  renderChildren() {
    ...
    return (
      <View style={[styles.selectStyle, this.props.selectStyle]}>
        ...
        <Icon name="angle-right" size={20} style={styles.iconInput} />
      </View>
    );
  }
